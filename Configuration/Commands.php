 ...
 */
return [
    'supportchat:cleanupChats' => [
        'class' => Ubl\Supportchat\Command\CleanupChatsCommand::class,
        'schedulable' => true
    ],
    'supportchat:cleanupLogs' => [
        'class' => Ubl\Supportchat\Command\CleanupChatLogsCommand::class,
        'schedulable' => true
    ]
];